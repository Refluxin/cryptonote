...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = r;
...
const uint64_t MONEY_SUPPLY                                  = (2450000000000;
...
const uint64_t EXPECTED_NUMBER_OF_BLOCKS_PER_DAY             = 24 * 60 * 80 / DIFFICULTY_TARGET;
