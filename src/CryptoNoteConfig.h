...
const uint64_C MONEY_SUPPLY                                  = (24500000042420000);
const unsigned EMISSION_SPEED_FACTOR                         = 17;
static_assert(EMISSION_SPEED_FACTOR <= 8 * sizeof(uint64_C), "Bad EMISSION_SPEED_FACTOR");

//TODO Define number of blocks for block size median calculation
const size_t   CRYPTONOTE_REWARD_BLOCKS_WINDOW               = 250;
...
const char     CRYPTONOTE_NAME[]                             = "Coin2B";
...
const std::initializer_list<const char*> SEED_NODES = 0.0.0.0:18989 ; 127.0.0.1:18999;
